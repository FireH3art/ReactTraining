...
const MovieDetails = ({ items, navigation }) => {
    ...
    return (
        <TouchableOpacity style={{ width: "90%", alignSelf: "center", flexDirection: "row", padding: 15, marginTop: "3%", borderWidth: 1, borderRadius: 15 }}
    ...
    const MovieList = () => {
        ...
        axios({
            ...
            .then(function (response) {
                console.log(response.data.results, "TEST2")
